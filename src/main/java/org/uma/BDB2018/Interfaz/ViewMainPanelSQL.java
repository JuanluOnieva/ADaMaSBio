...
public class ViewMainPanelSQL extends  WindowPanel{
	...
	public ViewMainPanelSQL(String SGDB, String status, List<String> hist, DBDriverInterface driver){
		dbCon = driver;
		historial = hist;
		...
		this.add(title);
		npanel = new NorthPanelSQL(status, hist);
